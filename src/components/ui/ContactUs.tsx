            ...
            <div className="w-full mx-auto">
                <div className="mb-16 text-center">
                    ...
                    >
                        ...
                        please send an email to <span className="text-primary font-medium italic text-white">booking@jsincuya.com</span> or complete the form below.
                    </motion.p>
                </div>
                                ...
                                >
                                    ...
                                    <motion.div variants={itemVariants} className="pt-2">
                                        <button
                                            ...
                                            className={` text-white cursor-pointer h-12 px-8 w-full bg-primary hover:bg-primary/90 transition-all duration-300 ${formState === "submitting" ? "opacity-80" : ""
                                                }`}
                                        >
