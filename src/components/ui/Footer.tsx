...
export default function Footer() {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative h-[30vh] flex flex-wrap md:flex-nowrap items-center justify-center lg:gap-x-96 gap-x-20 md:space-y-0 sm:space-y-30"
      style={{ opacity }}
    >
      <div className="w-1/2 h-full flex justify-center sm:items-start md:items-start">
        <motion.img
          initial={{ opacity: 1, y: 20 }}
          transition={{ duration: 0.5 }}
          className="md:w-1/2 2xl:w-1/4"
          alt="Logo"
          src="/logo.png"
        />
      </div>
